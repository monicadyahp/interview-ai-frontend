...
export default function HeroSection() {
  return (
    <section
      className="relative mx-auto overflow-hidden w-[92%] h-[730px] md:w-[95%] md:w-[90%] lg:w-[90%] md:h-[980px] top-[23px] lg:h-[1020px] rounded-[30px] md:rounded-[40px] bg-[#F8F8FF] shadow-[0_10px_40px_rgba(140,94,173,0.08)]"
    >
      ...
      <div className="relative z-10 flex flex-col items-center pt-30 md:pt-40 lg:pt-50 px-4 md:px-8 pb-0">
        {/* Heading */}
        <h1 className="font-extrabold text-center text-[#1F1F1F] text-[30px] sm:text-[40px] md:text-[46px] lg:text-[54px] leading-[1.15] max-w-[950px] mb-5 md:mb-6 tracking-tight">
          Master the Art of the First Impression: Where AI Meets Career Readiness
        </h1>

        {/* Subtitle */}
        <p className="font-medium text-center text-[#52525C] text-[15px] sm:text-[16px] md:text-[18px] lg:text-[20px] leading-[1.6] max-w-[760px] mb-8 md:mb-10">
