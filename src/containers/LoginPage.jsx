...
const LoginPage = () => {
  ...
  // FIX: baca query param ?mode=signup → otomatis buka Sign Up
        ...
        >
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <button
              ...
              className="w-[48px] h-[48px] rounded-full border border-[#E5E5E5] flex items-center justify-center hover:scale-105 transition bg-white"
            >
              <img src="/icons/icloud.png" alt="iCloud" className="w-[28px] h-[28px] object-contain" />
            </button>
          </div>

          {/* SWITCH MODE */}
          <p className="text-center mt-6" style={{ fontFamily, fontSize: "13px", fontWeight: 400, color: "#666666" }}>
