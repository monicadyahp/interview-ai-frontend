...
const StatCard = ({ label, value, sub, subColor, iconSrc }) => (
  ...
  >
    <div>
      ...
      <p className="text-[26px] font-bold text-[#1E1E1E] leading-tight">
        {value}
      </p>
      {sub && (
        <p
          className="text-[12px] mt-1"
          style={{ color: subColor || "#22C55E" }}
        >
          {sub}
        </p>
      )}
        ...
        <div className="flex-1 px-6 py-6 overflow-auto">
          ...
          <div className="relative w-full rounded-[24px] overflow-hidden mb-6">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-8 py-10 max-w-[580px]">
              <h2
                className="text-white font-bold leading-[1.2] mb-3"
                style={{ fontFamily, fontSize: "clamp(18px, 2.2vw, 26px)" }}
              >
                {getGreeting()} {user?.username?.split(" ")[0] || "Angel"}!
                <br />
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-4">
            ...
            <div className="bg-white rounded-[20px] border border-[#ECECEC] p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  {["6M", "1Y"].map((t) => (
                    <button
                      key={t}
                      className="text-[13px] px-4 py-1.5 rounded-full font-semibold bg-[#7B4DFF] text-white"
                      style={{ fontFamily }}
                    >
                      {t}
                    </button>
              ...
              {isLoading ? (
                <div className="h-[240px] flex items-center justify-center text-[#999] text-[14px]">
                  Loading chart...
                </div>
              ) : (
                <ResponsiveContainer width="100%" height={240}>
                  <LineChart data={chartData}>
                    <XAxis
                      dataKey="label"
                      tick={{ fontSize: 13, fill: "#999", fontFamily }}
                      axisLine={false}
                      tickLine={false}
                    />
                    ...
                    <Line
                      ...
                      stroke="#7B4DFF"
                      strokeWidth={2.5}
                      dot={{ r: 5, fill: "#7B4DFF", strokeWidth: 0 }}
                      activeDot={{ r: 7 }}
                    />
                  </LineChart>
                </ResponsiveContainer>
            ...
            <div className="bg-white rounded-[20px] border border-[#ECECEC] p-6">
              <p
                className="text-[17px] font-bold text-[#1E1E1E] mb-5"
                style={{ fontFamily }}
              >
                Emotions Summary
              </p>
              ...
              <div className="flex flex-col gap-3">
                {isLoading ? (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          style={{
                            background: emotionColorMap[e.label] || "#A78BFA",
                          }}
                        />
                        <span
                  ...
                  ["Happy", "Sad", "Normal", "Fear", "Angry", "Disgust"].map(
                    (e) => (
                      <div
                        key={e}
                        className="flex items-center justify-between"
                      >
                        <div className="flex items-center gap-2">
                          <span
                            className="w-3 h-3 rounded-full"
                            style={{ background: emotionColorMap[e] }}
                          />
                          <span
                            className="text-[14px] text-[#444]"
                            style={{ fontFamily }}
                        ...
                        <span
                          className="text-[14px] font-semibold text-[#999]"
                          style={{ fontFamily }}
                        >
                          —
                        </span>
