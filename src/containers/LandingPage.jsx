...
const LandingPage = () => {
        ...
        return (
            <div className="loader-container">
                <div className="loader-content">
                    <h1 className="loader-logo">Interview<span> AI</span></h1>
    ...
    return (
        <>
            ...
            <div className="container" style={{ marginTop: '-1rem', marginBottom: '3rem', position: 'relative', zIndex: 10 }}>
                <div style={{ 
                    background: '#FDFBFF', padding: '12px 20px', borderRadius: '15px', 
                    border: '1px solid #F3EAFB', display: 'flex', alignItems: 'center', 
                    gap: '15px', boxShadow: '0 5px 15px rgba(140, 94, 173, 0.05)'
                }}>
                    <span style={{ 
                        background: '#8C5EAD', color: '#FFF', padding: '4px 10px', 
            ...
            <section className="section container" style={{ paddingBottom: '5rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                    ...
                    <p style={{ color: '#888' }}>Tiga pilar utama untuk kesuksesan interview kamu.</p>
                </div>

                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
                    {/* Fitur 1 */}
                    <div style={{ background: '#FFF', padding: '2rem', borderRadius: '25px', border: '1px solid #F3EAFB', textAlign: 'center', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
                        <i className='bx bx-face' style={{ fontSize: '3rem', color: '#8C5EAD' }}></i>
                        <h3 style={{ margin: '1rem 0' }}>Analisis Wajah</h3>
                        <p style={{ fontSize: '0.85rem', color: '#777' }}>AI kami mendeteksi 7 emosi dasar secara real-time untuk memastikan aura positifmu terpancar.</p>
                    </div>

                    {/* Fitur 2 */}
                    <div style={{ background: '#FFF', padding: '2rem', borderRadius: '25px', border: '1px solid #F3EAFB', textAlign: 'center', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
                        <i className='bx bx-stats' style={{ fontSize: '3rem', color: '#8C5EAD' }}></i>
                        <h3 style={{ margin: '1rem 0' }}>Statistik Progres</h3>
                        <p style={{ fontSize: '0.85rem', color: '#777' }}>Pantau perkembangan latihanmu melalui grafik mingguan dan total sesi yang terukur.</p>
                    </div>

                    {/* Fitur 3 */}
                    <div style={{ background: '#FFF', padding: '2rem', borderRadius: '25px', border: '1px solid #F3EAFB', textAlign: 'center', boxShadow: '0 10px 30px rgba(0,0,0,0.02)' }}>
                        <i className='bx bx-share-alt' style={{ fontSize: '3rem', color: '#8C5EAD' }}></i>
                        <h3 style={{ margin: '1rem 0' }}>Export & Bagikan</h3>
                        <p style={{ fontSize: '0.85rem', color: '#777' }}>Simpan hasil analisismu dalam desain Instastory premium dan bagikan progresmu ke dunia.</p>
                    </div>
                </div>
            ...
            <section className="section container" style={{ paddingBottom: '7rem' }}>
                <div style={{ 
                    ...
                    <h2 style={{ color: '#FFF', fontSize: '2.2rem', marginBottom: '1rem', fontWeight: '800' }}>
                        Siap Menguasai Interview Kamu?
                    </h2>
                    <p style={{ marginBottom: '2.5rem', opacity: 0.9, fontSize: '1.1rem', maxWidth: '600px', margin: '0 auto 2.5rem' }}>
                        Jangan biarkan rasa gugup menghalangi karir impianmu. Mulai simulasi sekarang dan jadilah kandidat yang tak terlupakan.
                    </p>
                    <Link to="/interview" className="button" style={{ 
                        background: '#8C5EAD', 
                        color: '#c497e4', 
                        padding: '1.2rem 3rem', 
                        borderRadius: '18px', 
                        ...
                        Mulai Sekarang <i className='bx bx-right-arrow-alt' style={{ fontSize: '1.4rem' }}></i>
                    </Link>
                </div>
            </section>
        </>
