...
import { ChevronLeft, ChevronRight, Plus, Mic, Camera } from "lucide-react";
            ...
            <>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-5">
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <select value={selectedDuration} onChange={(e) => setSelectedDuration(Number(e.target.value))}
                      className="bg-white border border-[#ECECEC] rounded-[14px] px-4 py-2 text-[13px] font-semibold outline-none cursor-pointer">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button onClick={() => { setStatus("PREPARE"); setTimer(5); }}
          ...
          {(status === "PREPARE" || status === "RECORDING" || status === "RESULT") && (
            <>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="bg-white border border-[#ECECEC] rounded-[14px] px-4 py-2 text-[13px] font-semibold">
              ...
              {status === "RECORDING" && (
                <div className="bg-[#F3ECFF] rounded-[14px] px-5 py-3 flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[13px] font-semibold text-[#7B4DFF]">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="bg-white rounded-[20px] border border-[#ECECEC] p-5">
                    ...
                    {isAddingQuestion ? (
                      ...
                      <p className="text-[14px] font-semibold text-[#1E1E1E] leading-relaxed mb-3">
                    ...
                    {calculateStats().length > 0 && (
                      <div className="mt-3 pt-3 border-t border-[#F0F0F0]">
                        <p className="text-[12px] font-bold text-[#999] mb-2">EMOTION RECAP</p>
