...
const InterviewRoom = () => {
  ...
  const startRecording = useCallback(() => {
    ...
    const mediaRecorder = new MediaRecorder(webcamRef.current.video.srcObject, {
      mimeType: "video/webm",
    });
    ...
    if ((status === "PREPARE" || status === "RECORDING") && timer > 0) {
      ...
      if (status === "PREPARE") {
        if (webcamRef.current)
          setCapturedUserPhoto(webcamRef.current.getScreenshot());
        setStatus("RECORDING");
    ...
    <div className="min-h-screen flex bg-[#F7F7FB]" style={{ fontFamily }}>
      {isLoading && (
        <div className="fixed inset-0 bg-white/90 z-[9999] flex flex-col items-center justify-center">
          ...
          <p
            className="mt-5 text-[#7B4DFF] font-semibold"
            style={{ fontFamily }}
          >
      ...
      <main className="flex-1 flex flex-col min-w-0 lg:ml-[240px]">
        ...
        <div className="flex-1 px-4 sm:px-6 py-5 sm:py-6 overflow-auto">
          ...
          {status === "IDLE" && (
            <>
              <h1
                className="text-[24px] md:text-[28px] font-bold text-[#1E1E1E] mb-1"
                style={{ fontFamily }}
              >
                Prepare for Your AI Interview Simulation
              </h1>
              <p
                className="text-[14px] text-[#777] mb-6"
                style={{ fontFamily }}
              >
                Practice your interview skills in real-time with our advanced AI
                coach. Get instant feedback on your performance and confidence.
              </p>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-5">
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div className="bg-white border border-[#ECECEC] rounded-[14px] px-4 py-2.5 flex items-center justify-between sm:justify-start gap-2 shadow-sm">
                      <span
                      ...
                      <span
                        className="text-[13px] font-bold text-[#7B4DFF]"
                        style={{ fontFamily }}
                      >
                        {liveEmotion}
                      </span>
                    ...
                    <select
                      ...
                      className="w-full sm:w-auto bg-white border border-[#ECECEC] rounded-[14px] px-4 py-2.5 text-[13px] font-semibold outline-none cursor-pointer shadow-sm"
                      style={{ fontFamily }}
                    >
                      {[10, 15, 30, 60].map((d) => (
                  ...
                  {/* Camera area */}
                  <div className="relative rounded-[20px] overflow-hidden bg-[#1a1a2e] h-[300px] sm:h-[400px] xl:h-[480px]">
                    {!cameraOpen ? (
                      <>
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                          ...
                          <p
                            className="text-white/70 text-[14px] mb-2"
                            style={{ fontFamily }}
                          >
                          ...
                          <button
                            ...
                            style={{
                              background:
                                "linear-gradient(90deg, #7B4DFF, #C026D3)",
                              fontFamily,
                            }}
                          >
                            Open Camera
                  ...
                  {/* Mission Form */}
                  <div className="bg-white rounded-[20px] border border-[#ECECEC] p-5 sm:p-6">
                    <p
                      className="text-[11px] font-bold text-[#999] tracking-widest mb-4"
                      style={{ fontFamily }}
                    >
                      SET YOUR MISSION
                    </p>
                    <div className="mb-4">
                      <label
                        className="text-[15px] font-bold text-[#1E1E1E] mb-2 block"
                        style={{ fontFamily }}
                      >
                        Position Applied
                      </label>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex gap-2 flex-wrap">
                        {["Startup", "Corporate", "Agency", "Tech Company"].map(
                          (type) => (
                            <button
                              key={type}
                ...
                <div className="flex flex-col gap-4">
                  <div className="bg-white rounded-[20px] border border-[#ECECEC] p-5">
                    <p
                      className="text-[15px] font-bold text-[#1E1E1E] mb-4"
                      style={{ fontFamily }}
                    >
                      Interview Blueprint
                    </p>
                      ...
                      {[
                        {
                          ...
                          title: "15 Questions",
                          sub: "Curated for your level",
                        },
                        {
                          icon: "/icons/star.png",
                          title: "STAR Method",
                          sub: "AI Evaluation Strategy",
                        },
                        {
                          icon: "/icons/analysis.png",
                          title: "Emotional Analysis Enabled",
                          sub: "Vibe & Confidence check",
                        },
                      ].map((item) => (
                        <div
                          key={item.title}
                  ...
                  <button
                    onClick={() => {
                      if (!positionApplied.trim()) {
                        Swal.fire({
                          title: "Position Applied wajib diisi",
                          text: "Isi dulu posisi yang kamu lamar sebelum memulai simulasi.",
                          icon: "warning",
          ...
          {(status === "PREPARE" ||
            ...
            <>
              ...
              <p
                className="text-[14px] text-[#777] mb-5"
                style={{ fontFamily }}
              >
                Practice in real-time with an advanced AI coach. Get instant
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-3">
                ...
                <div
                  className="bg-white border border-[#ECECEC] rounded-[14px] px-4 py-2.5 text-[13px] font-semibold shadow-sm text-center sm:text-left"
                  style={{ fontFamily }}
                >
              ...
              {/* Session Active bar */}
              {status === "RECORDING" && (
                <div className="bg-[#F3ECFF] rounded-[14px] px-4 sm:px-5 py-3 flex flex-wrap items-center gap-2 sm:gap-3 mb-4">
                  <div className="w-2 h-2 bg-[#7B4DFF] rounded-full animate-pulse" />
                  <span
                    className="text-[13px] font-semibold text-[#7B4DFF]"
                    style={{ fontFamily }}
                  >
                    Session Active |{" "}
              ...
              <div className="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-5">
                <div className="flex flex-col gap-4">
                  {/* Camera */}
                  <div className="relative rounded-[20px] overflow-hidden bg-black h-[300px] sm:h-[400px] xl:h-[480px]">
                    {status === "RESULT" ? (
                      recordedVideoURL ? (
                        <video
                          controls
                        ...
                        <div className="w-full h-full flex items-center justify-center text-white text-[14px]">
                          Preparing video...
                        </div>
                      )
                    ) : (
                    ...
                    {status === "PREPARE" && (
                      <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center text-white">
                        <h1 className="text-[64px] sm:text-[80px] font-bold leading-none">
                          {timer}
                        </h1>
                  ...
                  <div className="bg-white rounded-[20px] border border-[#ECECEC] p-5">
                    <label
                      className="text-[13px] font-bold text-[#999] tracking-wider"
                      style={{ fontFamily }}
                    >
                      Notes:
                    </label>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="bg-white rounded-[20px] border border-[#ECECEC] p-5">
                    ...
                    <div className="flex flex-col gap-2.5">
                      {[
                        ...
                        {
                          key: "R",
                          desc: "Quantify your impact (e.g., latency reduction)",
                        },
                      ].map((item) => (
                        <div key={item.key} className="flex items-start gap-3">
                          <span
                            className="text-[13px] font-bold text-[#7B4DFF] w-4"
                            style={{ fontFamily }}
                          >
                            {item.key}:
                          </span>
                  ...
                  <div className="bg-white rounded-[20px] border border-[#ECECEC] p-5">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span
                        className="text-[12px] text-[#666] flex-1 text-center"
                        style={{ fontFamily }}
                      >
                    ...
                    {isAddingQuestion ? (
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 h-[40px] rounded-[12px] border border-[#E7E7E7] px-3 outline-none text-[13px]"
                          style={{ fontFamily }}
                        />
                        <button
                          onClick={handleAddNewQuestion}
                          className="px-3 rounded-[12px] bg-[#7B4DFF] text-white font-semibold text-[12px]"
                          style={{ fontFamily }}
                        >
                          Save
                        </button>
                      ...
                      <p
                        className="text-[13px] text-[#444] leading-relaxed mb-3 bg-[#F7F7FB] rounded-[12px] p-3"
                        style={{ fontFamily }}
                      >
                          ...
                          {calculateStats().map((stat) => (
                            <div key={stat.label}>
                              <div className="flex justify-between mb-1">
                                ...
                                <span
                                  className="text-[12px] font-bold text-[#7B4DFF]"
                                  style={{ fontFamily }}
                                >
                                  {stat.value}%
                                </span>
      ...
      {showFeedback && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div
            className="bg-white rounded-[24px] w-full max-w-[440px] p-6 sm:p-8 shadow-2xl"
            style={{ fontFamily }}
          >
              ...
              {[1, 2, 3, 4, 5].map((score) => (
                ...
                >
                  <img
                    ...
                    style={{
                      opacity:
                        feedbackScore && feedbackScore !== score ? 0.4 : 1,
                    }}
                  />
                </button>
              ))}
